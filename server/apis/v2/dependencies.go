...
func NewClusterHandler(podViewMode observability.PodViewMode) (*Handler, error) {
	...
	service, err := observability.NewService(numaflowClient.NumaflowV1alpha1(), podViewMode)
	if err != nil {
		return nil, err
	}
